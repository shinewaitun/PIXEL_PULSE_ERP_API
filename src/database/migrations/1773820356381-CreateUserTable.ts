...
export class CreateUserTable1773820356381 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_021e2c9d9dca9f0885e8d738326\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_b75c92ef36f432fe68ec300a7d4\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_c654b438e89f6e1fbd2828b5d3\` ON \`users\``,
    );
